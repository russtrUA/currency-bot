...
public class Constants {
    ...
    public static final String CURRENCIES_BUTTON_NAME = "\uD83D\uDCB5 Валюти";
    public static final String BACK_BUTTON = "\uD83D\uDD19 Назад";
    public static final String CHECKED_ITEM = "✅ ";
    public static final String USER_SETTINGS_FILE = "./files/settings/user_settings.json";
    ...
    public static final String BACK_TO_MAIN_BUTTON = "\uD83D\uDD19 Назад до головного меню";
}
